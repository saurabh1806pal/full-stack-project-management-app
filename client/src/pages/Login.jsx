...
const Slider = () => {
  ...
  return (
    <div
      className="w-full rounded-2xl p-8 transition-colors duration-700 mb-8 min-h-[172px] flex flex-col justify-between"
...
const Login = () => {
  ...
  return (
    <div className="light min-h-screen bg-neutral-50 flex items-center justify-center px-4" style={{ colorScheme: "light" }}>
      <div className="w-full max-w-md">
        ...
        >
          <svg viewBox="0 0 100 100" className="w-7 h-7" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div className="bg-white rounded-2xl border border-neutral-200 shadow-sm shadow-neutral-100 p-8">
          ...
          {/* Heading */}
          <div className="mb-6">
            <h2 className="text-xl font-bold text-neutral-950 tracking-tight">Welcome back</h2>
            <p className="text-sm text-neutral-400 mt-0.5">Sign in to continue to your workspace.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                required
                autoComplete="email"
                className="w-full px-3.5 py-2.5 text-sm rounded-lg border border-neutral-200
          ...
          <p className="mt-6 text-center text-sm text-neutral-400">
            ...
            <Link to="/register" className="font-semibold text-neutral-800 hover:text-neutral-950 transition-colors duration-150">
              Sign up
            </Link>
          </p>
        </div>
